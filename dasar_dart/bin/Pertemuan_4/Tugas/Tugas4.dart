...
void main() {
  final String namaRestoran = "Restoran Suka Maju";

  final Map<int, Map<String, dynamic>> makanan = {
    1: {"nama": "Ayam Goreng Mentega", "harga": 45000},
    2: {"nama": "Nasi Goreng", "harga": 12000},
    3: {"nama": "Ayam Geprek", "harga": 30000},
  };

  final Map<int, Map<String, dynamic>> minuman = {
    1: {"nama": "Es Teh", "harga": 5000},
    2: {"nama": "Es Jeruk", "harga": 6000},
    3: {"nama": "Kopi", "harga": 8000},
  };
